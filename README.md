...
4. Также сделайте действие пароля и учетной записи бессрочными:

Для всех аккаунтов на устройстве:

net accounts /maxpwage:unlimited

Если нужно изменить настройки только для конкретной учетной записи, используйте команду WMIC. В командной строке с правами администратора выполните (замените ИмяПользователя на фактическое):

wmic UserAccount where Name="ИмяПользователя" set PasswordExpires=False 

5. И обновите пароль на всех клиентах:

Windows 7: в start_database.bat

Red OS: в database_client/config.env
